                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        ...
                        $sql = mysqli_query($conn, "SELECT * FROM violators WHERE deleted=0");
                      ...
                      ?>
                        ...
                        <td>
                          <?php if($row['payment'] == "Unpaid"): ?>
                            <a type="button" class="text-primary" data-toggle="modal" data-target="#paid<?php echo $row['violator_Id']; ?>">Mark as paid</a>
                          <?php else: ?>
                        ...
                        <td>
                            <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <a href="violators_view.php?violator_Id=<?php echo $row['violator_Id']; ?>" type="button" class="btn btn-primary dropdown-item">View</a>
                                      <a href="violators_update.php?violator_Id=<?php echo $row['violator_Id']; ?>" type="button" class="btn btn-primary dropdown-item">Update</a>
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#profile<?php echo $row['violator_Id']; ?>">Update profile</button>
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#delete<?php echo $row['violator_Id']; ?>">Archive</button>
                                </div>
                            </div>
                        </td> 
                    </tr>
