              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped text-sm">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM impound JOIN violators ON impound.impound_violator_Id=violators.violator_Id WHERE impound.deleted=0");
                        ...
                        <td>
                            <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      ...
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#delete<?php echo $row['impound_Id']; ?>">Arhive</button>
                                </div>
                            </div>
                        </td> 
                    </tr>
