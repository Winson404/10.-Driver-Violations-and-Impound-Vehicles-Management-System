<title>Profile update | Report Mgmt. System</title>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-sm"  placeholder="Usertype" name="usertype" required onkeyup="lettersOnly(this)" value="<?php echo $row['user_type']; ?>" readonly>
                              <?php else: ?>
                              <input type="text" class="form-control form-control-sm"  placeholder="Usertype" name="usertype" required onkeyup="lettersOnly(this)" value="<?php echo $row['user_type']; ?>">
                              <?php endif; ?>
                            </div>
                        </div>
                      </div>
