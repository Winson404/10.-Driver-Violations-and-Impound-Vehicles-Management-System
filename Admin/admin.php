<title>Administrators | Report Mgmt. System</title>
                      ...
                      ?>
                        ...
                        <td>
                          <?php if($row['user_type'] == 'Admin'): ?>
                              <span class="badge badge-primary rounded-pill"><?php echo $row['user_type']; ?></span></td>
                          <?php else: ?>
                              <span class="badge badge-success rounded-pill"><?php echo $row['user_type']; ?></span></td>
                          <?php endif; ?>
                        <td>
