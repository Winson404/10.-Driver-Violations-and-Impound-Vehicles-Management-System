...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header text-center p-2 navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="login.php" class="navbar-brand">
        <span class="brand-text font-weight-light">Centralized Driver Violations and Impound Vehicles Report Management System for PNP and POSU in Cabatuan Isabela</span>
      </a>
