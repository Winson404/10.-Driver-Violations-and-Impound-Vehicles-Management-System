    ...
    $key  = substr(number_format(time() * rand(), 0, '', ''), 0, 6);
      ...
      if($check_code == NULL) {
        ...
        if($insert_code) {
          ...
          <p>You can change your password by just clicking it <a href="http://localhost/PROJECT%2013.%20Driver%20Violations%20and%20Impound%20Vehicles%20Management%20System//changepassword2.php?admin_Id='.$admin_Id.'&&email='.$email.'&&key='.$code.'">here!</a></p> 
...
<?php } } // CLOSING TAG IF CODE IS NULL
    ...
    $update_code = mysqli_query($conn, "UPDATE admin SET verification_code='$key' WHERE admin_Id='$admin_Id'");
    if($update_code) {
