  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
       <div class="modal-header alert-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Delete violator</h5>
      ...
      <div class="modal-body">
        <form action="process_delete.php" method="POST">
          ...
          <h5 class="text-center">Delete violator record?</h5>
      </div>
      <div class="modal-footer alert-light">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa-solid fa-ban"></i> Cancel</button>
        <button type="submit" class="btn btn-danger" name="delete_violator"><i class="fa-solid fa-trash"></i> Delete</button>
      </div>
        </form>
    </div>
  </div>
